...
router.post('/archive-live', authenticate, upload.single('file'), (req, res) => sheetController.archiveLive(req, res));
...
router.get('/saved/:id', authenticate, (req, res) => sheetController.getSavedDetail(req, res));
